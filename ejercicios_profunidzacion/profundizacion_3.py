...
print('Nombre Completo todo minúsculas:',nombrecompleto.lower())
print('Nombre Completo todo mayúsculas:',nombrecompleto.upper())
print('Nombre Completo Primera letra capital',nombre.capitalize(),apellido.capitalize())
